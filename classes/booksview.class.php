...
class BooksView extends Books {
    ...
    public function showBooks($page = 0, $search="",$filter="",$mode=""){
        $result = $this->getBooks(1 + $page * 20, $search,$filter,$mode);
                        ...
                        <div class='card text-white border-secondary'>
                            ...
                            <p class='card-text'> $text </p>
                                <div class='cardfooter'>
                                 <a href='index.php?mode=info&book=$id' data-bs-toggle='tooltip' title='More details about the book'><svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='currentColor' class='bi bi-info-square' viewBox='0 0 16 16'>
